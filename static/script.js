...
// ===== NEW CHAT =====
function newChat(){
  // prevent duplicate empty chat
  if(!hasStarted && chats.length>0) return;
...
form.onsubmit=async(e)=>{
  ...
  if(msg.match(/what|who|when|where|why/i)) mode="search";
  ...
  try{
    ...
    thinking.wrap.innerHTML="<p>⚠️ Network error</p>";
  }
